...
class SubscriptionForm(forms.ModelForm):
    name = forms.CharField(
        label="Name", widget=forms.TextInput(attrs={"class": "form-input"})
    )
    email = forms.CharField(
        label="Email", widget=forms.EmailInput(attrs={"class": "form-input"})
    )
    card_number = forms.ImageField(
        label="Card number", widget=forms.TextInput(attrs={"class": "form-input"})
    )
    exp_month = forms.IntegerField(
        label="Expire month", widget=forms.TextInput(attrs={"class": "form-input"})
    )
    exp_year = forms.IntegerField(
        label="Expire year", widget=forms.TextInput(attrs={"class": "form-input"})
    )
    cvc = forms.IntegerField(
        label="CVC", widget=forms.TextInput(attrs={"class": "form-input"})
    )
